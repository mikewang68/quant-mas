...
def get_ip_from_ip138_iframe():
    """
    直接获取ip138.com iframe中的IP地址
    """
    # Firecrawl API端点
...
def get_ip_from_ip138_iframe_with_wait():
    """
    直接获取ip138.com iframe中的IP地址 (带等待)
    """
    # Firecrawl API端点
    firecrawl_url = "http://192.168.1.2:8080/v1/scrape"
    ...
    try:
        print(f"正在向 {firecrawl_url} 发送请求 (带等待)...")
        print(f"目标网址: {target_url}")
...
if __name__ == "__main__":
    print("=== 使用Firecrawl获取ip138.com iframe中的IP地址 ===\n")

    print("方法1: 直接访问iframe")
    ips1 = get_ip_from_ip138_iframe()

    print("\n" + "="*50 + "\n")

    print("方法2: 带等待的访问")
    ips2 = get_ip_from_ip138_iframe_with_wait()
    ...
    print("\n说明:")
    print("1. ip138.com通过iframe显示访问者的公网IP地址")
