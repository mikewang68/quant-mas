#!/usr/bin/env python3
"""
Test script for WMA Turnover Strategy
"""
...
from strategies.wma_turnover_strategy import WMATurnoverStrategy
...
def test_wma_turnover_strategy():
    """Test the WMA Turnover Strategy"""
    print("Testing WMA Turnover Strategy...")

    try:
        # Create strategy instance
        strategy = WMATurnoverStrategy(
            name="Test WMA Turnover Strategy",
            params={
                "short_period": 5,
                "mid_period": 13,
                "min_turnover": 5.0,
...
if __name__ == "__main__":
    success = test_wma_turnover_strategy()
    if success:
        print("\n✓ WMA Turnover Strategy test completed successfully")
        sys.exit(0)
    else:
        print("\n✗ WMA Turnover Strategy test failed")
        sys.exit(1)
