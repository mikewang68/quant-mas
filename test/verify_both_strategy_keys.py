#!/usr/bin/env python3
"""
Test script to verify that the strategy_key is now using the strategy_id value for both strategies.
"""
...
def test_both_strategies():
    """Test that strategy_key now uses the strategy_id value for both strategies"""
    try:
