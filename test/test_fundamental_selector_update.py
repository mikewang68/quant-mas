...
def test_fundamental_selector_update():
    """Test if fundamental selector can correctly update pool records"""
    print("=== Testing Fundamental Selector Pool Update ===")
    ...
    print(f"\n2. Testing fundamental selector update logic:")

    # Create fundamental selector instance
    fundamental_selector = FundamentalStockSelector()

    # Test the update_latest_pool_record method logic
    ...
    for fund_stock in fundamental_stocks:
        ...
        print(f"    Would write to fund[{strategy_name}]: {fund_data}")
...
if __name__ == "__main__":
    test_fundamental_selector_update()
