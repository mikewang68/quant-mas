...
def check_database():
    ...
    try:
        ...
        agents = list(agents_collection.find({}, {'_id': 1, 'name': 1, 'description': 1, 'status': 1, 'strategies': 1}))
        ...
        strategies = list(strategies_collection.find({}, {'_id': 1, 'name': 1, 'type': 1, 'description': 1, 'parameters': 1}))
