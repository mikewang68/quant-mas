...
def search_for_combined_programs():
    ...
    # Search for files that might call both weekly selector and technical selector
    combined_programs = []
    ...
    for file_path in python_files:
        try:
            with open(file_path, 'r', encoding='utf-8') as f:
                ...
                if (has_weekly_selector and has_technical_selector) or (has_golden_cross and has_technical_analysis):
